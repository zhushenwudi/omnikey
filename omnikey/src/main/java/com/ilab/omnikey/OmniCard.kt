...
object OmniCard {
    ...
    private const val HAVE_NO_CONTEXT = "you need bind first"
    const val READER_NOT_FOUND = "reader not found"
    private const val READER_ATTACH = "reader attach"
    private const val READER_DETACH = "reader detach"
    const val HAVE_NO_CARD = "card detach"
    const val APK_NAME = "omni_reader.apk"
    const val PACKAGE_NAME = "com.hidglobal.cardreadermanager"
    const val CARD_PERMISSION = Constants.PERMISSION_TO_BIND_BACKEND_SERVICE
    ...
    fun bind(context: Application, code: MutableLiveData<Pair<Status, String>>, isInit: Boolean) {
        mutableCode = code
